...
class ActivityTrackerService extends ChangeNotifier {
  ...
  Future<void> loadActivityForDate(DateTime day) async {
    ...
    // Сначала загрузим данные из Firestore, если есть
    ...
    // Попробуем обновить шаги из Google Fit (если доступ разрешён)
    await refreshFromHealth();

    // Сохраняем всегда, даже если данные не изменились
